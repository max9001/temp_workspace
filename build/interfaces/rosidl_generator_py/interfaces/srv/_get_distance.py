...
class Metaclass_GetDistance(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from interfaces.srv import _get_distance
...
class GetDistance(metaclass=Metaclass_GetDistance):
    from interfaces.srv._get_distance import GetDistance_Request as Request
    from interfaces.srv._get_distance import GetDistance_Response as Response
