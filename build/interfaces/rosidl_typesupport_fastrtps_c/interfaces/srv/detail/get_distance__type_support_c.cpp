...
#include "interfaces/srv/detail/get_distance__rosidl_typesupport_fastrtps_c.h"
...
using _GetDistance_Request__ros_msg_type = interfaces__srv__GetDistance_Request;
...
size_t get_serialized_size_interfaces__srv__GetDistance_Request(
  const void * untyped_ros_message,
...
static uint32_t _GetDistance_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__srv__GetDistance_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__srv__GetDistance_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_interfaces__srv__GetDistance_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, srv, GetDistance_Request)() {
...
using _GetDistance_Response__ros_msg_type = interfaces__srv__GetDistance_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t get_serialized_size_interfaces__srv__GetDistance_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetDistance_Response__ros_msg_type * ros_message = static_cast<const _GetDistance_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__srv__GetDistance_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__srv__GetDistance_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_interfaces__srv__GetDistance_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, srv, GetDistance_Response)() {
...
// already included above
// #include "interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "interfaces/srv/get_distance.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, srv, GetDistance)() {
