...
#include "test_interfaces1/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _GetDistance_Request_type_support_symbol_names_t _GetDistance_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, test_interfaces1, srv, GetDistance_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_interfaces1, srv, GetDistance_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_test_interfaces1
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, test_interfaces1, srv, GetDistance_Request)() {
  return &::test_interfaces1::srv::rosidl_typesupport_c::GetDistance_Request_message_type_support_handle;
}
...
static const _GetDistance_Response_type_support_symbol_names_t _GetDistance_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, test_interfaces1, srv, GetDistance_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_interfaces1, srv, GetDistance_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_test_interfaces1
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, test_interfaces1, srv, GetDistance_Response)() {
  return &::test_interfaces1::srv::rosidl_typesupport_c::GetDistance_Response_message_type_support_handle;
}
...
static const _GetDistance_type_support_symbol_names_t _GetDistance_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, test_interfaces1, srv, GetDistance)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_interfaces1, srv, GetDistance)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, test_interfaces1, srv, GetDistance)() {
  return &::test_interfaces1::srv::rosidl_typesupport_c::GetDistance_service_type_support_handle;
}
