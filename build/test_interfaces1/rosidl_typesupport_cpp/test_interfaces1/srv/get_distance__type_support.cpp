...
static const _GetDistance_Request_type_support_symbol_names_t _GetDistance_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, test_interfaces1, srv, GetDistance_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, test_interfaces1, srv, GetDistance_Request)),
  }
};
...
{
  return &::test_interfaces1::srv::rosidl_typesupport_cpp::GetDistance_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, test_interfaces1, srv, GetDistance_Request)() {
  return get_message_type_support_handle<test_interfaces1::srv::GetDistance_Request>();
}
...
static const _GetDistance_Response_type_support_symbol_names_t _GetDistance_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, test_interfaces1, srv, GetDistance_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, test_interfaces1, srv, GetDistance_Response)),
  }
};
...
{
  return &::test_interfaces1::srv::rosidl_typesupport_cpp::GetDistance_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, test_interfaces1, srv, GetDistance_Response)() {
  return get_message_type_support_handle<test_interfaces1::srv::GetDistance_Response>();
}
...
static const _GetDistance_type_support_symbol_names_t _GetDistance_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, test_interfaces1, srv, GetDistance)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, test_interfaces1, srv, GetDistance)),
  }
};
...
{
  return &::test_interfaces1::srv::rosidl_typesupport_cpp::GetDistance_service_type_support_handle;
}
