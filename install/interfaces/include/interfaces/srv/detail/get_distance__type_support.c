...
#include <stddef.h>
#include "interfaces/srv/detail/get_distance__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember GetDistance_Request__rosidl_typesupport_introspection_c__GetDistance_Request_message_member_array[2] = {
  {
    ...
    offsetof(interfaces__srv__GetDistance_Request, x),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces__srv__GetDistance_Request, y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers GetDistance_Request__rosidl_typesupport_introspection_c__GetDistance_Request_message_members = {
  ...
  2,  // number of fields
  sizeof(interfaces__srv__GetDistance_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interfaces, srv, GetDistance_Request)() {
...
static rosidl_typesupport_introspection_c__MessageMember GetDistance_Response__rosidl_typesupport_introspection_c__GetDistance_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces__srv__GetDistance_Response, distance),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers GetDistance_Response__rosidl_typesupport_introspection_c__GetDistance_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(interfaces__srv__GetDistance_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interfaces, srv, GetDistance_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers interfaces__srv__detail__get_distance__rosidl_typesupport_introspection_c__GetDistance_service_members = {
  "interfaces__srv",  // service namespace
  "GetDistance",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // interfaces__srv__detail__get_distance__rosidl_typesupport_introspection_c__GetDistance_Request_message_type_support_handle,
  NULL  // response message
  // interfaces__srv__detail__get_distance__rosidl_typesupport_introspection_c__GetDistance_Response_message_type_support_handle
};

static rosidl_service_type_support_t interfaces__srv__detail__get_distance__rosidl_typesupport_introspection_c__GetDistance_service_type_support_handle = {
  0,
  &interfaces__srv__detail__get_distance__rosidl_typesupport_introspection_c__GetDistance_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interfaces, srv, GetDistance)() {
  if (!interfaces__srv__detail__get_distance__rosidl_typesupport_introspection_c__GetDistance_service_type_support_handle.typesupport_identifier) {
    interfaces__srv__detail__get_distance__rosidl_typesupport_introspection_c__GetDistance_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)interfaces__srv__detail__get_distance__rosidl_typesupport_introspection_c__GetDistance_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interfaces, srv, GetDistance_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interfaces, srv, GetDistance_Response)()->data;
  }

  return &interfaces__srv__detail__get_distance__rosidl_typesupport_introspection_c__GetDistance_service_type_support_handle;
}
